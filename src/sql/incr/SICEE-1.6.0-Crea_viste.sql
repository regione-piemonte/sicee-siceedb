...
create or replace view V_ACE_ANNOCOSTR_CLASSE 
as 
select classe1.descr,classe1 "fino al 1900",classe2 "dal 1901 al 1920",classe3 "dal 1921 al 1945",classe4 "dal 1946 al 1960", 
...
where sicee_t_certificato.ID_CERTIFICATORE = sicee_t_classe_energetica.ID_CERTIFICATORE
  ...
  and sicee_t_certificato.id_certificatore > 100 
  and sicee_t_certificato.DT_UPLOAD <'31-DIC-2011'
...
where classe1.descr = classe2.descr 
  and classe1.descr = classe3.descr
  and classe1.descr = classe4.descr
  and classe1.descr = classe5.descr
  and classe1.descr = classe6.descr
  and classe1.descr = classe7.descr
  and classe1.descr = classe8.descr
order by classe1.id_classe;  

  
create or replace view V_ACE_COMUNE_CLASSE
as
...
where cer.desc_comune is not null
  and cer.fk_stato = 3 
  and cer.id_certificatore > 100
  and cer.DT_UPLOAD <= '31-DIC-2011'
